...
class ProviderRepositoryTest {
    ...
    void orphanRemovalTest() {
        ...
        Product product1 = savedProduct("상품1-1", 1000, 1000);
        Product product2 = savedProduct("상품2-1", 500, 1500);
        Product product3 = savedProduct("상품3-1", 750, 500);
        ...
        // 연관관계 제거
        Provider foundProvider = providerRepository.findById(8L).get();
